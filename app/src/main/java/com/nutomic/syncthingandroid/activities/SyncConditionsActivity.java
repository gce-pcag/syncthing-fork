...
public class SyncConditionsActivity extends SyncthingActivity {
    ...
    private static final String EXTRA_OBJECT_PREFIX_AND_ID =
            "com.github.nel0x.syncthingandroid.activities.SyncConditionsActivity.OBJECT_PREFIX_AND_ID";

    private static final String EXTRA_OBJECT_READABLE_NAME =
            "com.github.nel0x.syncthingandroid.activities.SyncConditionsActivity.OBJECT_READABLE_NAME";
