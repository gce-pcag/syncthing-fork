...
public class AppConfigReceiver extends BroadcastReceiver {
     ...
     */
    private static final String ACTION_START = "com.github.nel0x.syncthingandroid.action.START";
     ...
     */
    private static final String ACTION_STOP  = "com.github.nel0x.syncthingandroid.action.STOP";
